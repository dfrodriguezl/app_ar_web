    ...
    return [
        {
            name: "Colegio",
            location: {
                lat: 4.716322, // add here latitude if using static data
                lng: -74.140995, // add here longitude if using static data
            }
        },
        {
            name: 'Casa de Diego',
